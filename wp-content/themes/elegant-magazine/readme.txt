...
* Update - Unused files removed compatibility
* Update - Block design improvement
* Update - Improved some design glitch

### 3.2.0 - Jan 27 2023 =
* Update - Improved menu design
* Update - Improved site footer color and borders
* Update - Improved horizontal overflow in small screen
* Update - Improved some design glitch
...
### 3.0.0 - Aug 04 2022 =
* Update - Multi-authors supported 
* Update - Improved some design glitch

### 2.0.2 - Jun 30 2022 =
* Update - Improved banner background
* Update - Improved some design glitch

### 2.0.1 - Jun 30 2022 =
* Update - Improved banner height
* Update - Improved some design glitch


### 2.0.0 - Jun 29 2022 =
* Update - Improved Theme Dashboard with essentials links
