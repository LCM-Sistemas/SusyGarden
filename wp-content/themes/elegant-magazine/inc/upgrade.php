...
class ElegantMagazine_Upgrade_Notice extends ElegantMagazine_Notice {
    ...
    public function notice_markup() {
        ?>
        <div class="notice notice-success elegant_magazine-notice" >
            <a class="elegant_magazine-notice-dismiss notice-dismiss" href="<?php echo esc_url( $this->dismiss_url ); ?>"></a>
            ...
            <p class="notice-text">
                ...
                /* Translators: %1$s current user display name., %2$s this theme name., %3$s discount coupon code., %4$s discount percentage. */
                   esc_html__(
                        '%1$s 🎁 Hope you\'re loving our free %2$s theme! Ready for an upgrade? Dive into the festive spirit with an exclusive gift: %4$s premium features! Use code %3$s at checkout. Wishing you a season filled with joyous holidays and even happier savings! 🎄✨',
                        'elegant-magazine'
                    ),
                    '<h3> Greetings ' . esc_html( $current_user->display_name ) . '! Unlock a Special Treat: 30% Discount on Premium Features!</h3>',
                    'Elegant Magazine',
            ...
            <div class="links">
                ...
                <a href="https://afthemes.com/supports/" class="button button-secondary" target="_blank">
                    ...
                    <span><?php esc_html_e( 'Have Pre-sales Queries?', 'elegant-magazine' ); ?></span>
                </a>
            </div>
        </div> <!-- /elegant_magazine-notice -->
        <?php
    }
}
