...
function elegant_magazine_scripts()
{
    ...
    wp_enqueue_style('elegant-magazine-style', get_stylesheet_uri(), wp_get_theme()->get( 'Version' ));
...
if (!function_exists('elegant_magazine_esc_custom_style(')) {

    function elegant_magazine_esc_custom_style($props)
    {
